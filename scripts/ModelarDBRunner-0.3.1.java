...
class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < 3) {
      System.out.println("usage: java -cp ModelarDB-assembly-0.1.0.jar ModelarDBRunner-0.3.1.java parquetFilePath errorBoundsInPercentages modelsToUse(C L G P A LG)");
      return;
    }
